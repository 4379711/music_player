	...
	<div class="playlist-container">
		<div class="top-wrap">
			...
			<div class="info-wrap">
				...
				<div v-if="playlist.creator" class="author-wrap">
					<!-- 头像 -->
				...
				<div v-if="playlist.description" class="desc-wrap">
		...
		<el-tabs v-model="activeIndex">
			...
			<el-tab-pane :label="'评论('+ total +')'" name="2">
				...
				<div class="comment-wrap">
					...
					<div v-if="comments" class="comments-wrap">
						<!-- 循环最新评论数组，将评论渲染到页面 -->
...
export default {
	...
	computed: {
		...
		more () { // 是否显示查看更多按钮
			return this.playlist.description.length > 150
		}
	},
	created () {
		// 清空历史数据
